  ...
  <main className="container" style={{ paddingBottom: 28 }}>
    <section className="glass round-3xl hero">
      ...
      <div className="row">
        <button
          onClick={onParse}
          disabled={loading.parse || loading.assess || loading.create}
        ...
        <button
          onClick={onGenerate}
          disabled={!canGenerate || loading.parse || loading.assess || loading.create}
        ...
        <button
          ...
          disabled={!canCreate || loading.parse || loading.assess || loading.create}
